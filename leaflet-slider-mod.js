L.Control.Slider = L.Control.extend({
    ...
    _initLayout: function () {
        ...
        if(this.options.minmax) {
            this._max = L.DomUtil.create('a', className + '-max', this._container);
            this._max.innerHTML = this.options.max+"";
            L.DomEvent.on(this._max, 'click', this._setmax, this);
        ...
        if(this.options.minmax) {
            this._min = L.DomUtil.create('a', className + '-min', this._container);
            this._min.innerHTML = this.options.min+"";
            L.DomEvent.on(this._min, 'click', this._setmin, this);
        }
